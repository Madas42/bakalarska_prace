...
def weighted_undirected_lfr_as_nx(*args, **kwargs):
    ...
    nx.set_edge_attributes(nx_graph, {tuple(edge): weights[i]
                                                for i, edge in enumerate(edge_array)}, 'weight')
...
def weighted_directed_lfr_as_nx(*args, **kwargs):
    ...
    # Add edges to graph
    nx_graph.add_edges_from(edge_array)
    nx.set_edge_attributes(nx_graph, {tuple(edge): weights[i] for i, edge in enumerate(edge_array)}, 'weight')
